...
def handle_message(message):
    if message.text == "":
        ...
        bot.send_message(message.chat.id, "*Dm - @PEER_CHEATS_OWNERS @SURYANSHRL*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Owner - @PEER_CHEATS_OWNER @SURYANSHRL*", parse_mode='Markdown')
    else:
